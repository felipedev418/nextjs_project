...
import RainPool from "@/public/assets/svg/rainPool.svg";
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`w-[290px] ml-3 bg-[#1A1A19] h-[2px] border border-1px absolute z-55 top-[145px] ${
            pathname == "/" ? "reedgradient" : " yellogradient"
          }`}
        />
        <div className="flex border-[2px] !rounded-[15px] border-[#21201f]  overflow-hidden min-h-[120px] relative">
          <div className="py-5 pl-5 flex flex-col items-center gap-4">
            ...
            {pathname == "/" ? (
              ...
              <Button variant="secondary">
                <h2 className="px-1 text-gradient bg-gradient-to-t from-[#FFB9BE] to-[#FFFF]">
                  JOIN
                </h2>
              </Button>
              <Button className="border-[#21201f] border rounded-[15px]">
          ...
          <div className="absolute right-0">
            <h2 className="absolute right-3 mb-4 text-nowrap pt-5 text-xs font-medium text-[#9C9C9C] leading-4 uppercase">
              {pathname == "/" ? "Rain Pool" : "Flash Giveaway"}
            </h2>
            {pathname == "/" ? (
              <RainPool className="mt-[40px]" />
            ) : (
