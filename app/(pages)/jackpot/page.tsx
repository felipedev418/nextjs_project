        ...
        <div className="border border-[#272625] bg-[#1A1A19] flex flex-col items-center rounded-[38px] p-4 gap-[23px]">
          ...
          <div className="flex flex-col gap-[58px] items-center">
            ...
            <div className="flex flex-col gap-[5px] items-center">
              <div className={"text-[70px] font-stopbuck"}>$328.67</div>
                ...
                >
                  <Image
                    ...
                    className={cn(
                      ...
                      index % 2 === 1 ? "border-[#1DD6FF]" : "border-[#ED3440]"
                    )}
                    height={40}
                    width={50}
                  />
                    ...
                    <div className="flex justify-between w-full items-center">
                      <div className="flex text-[12px] leading-[14.4px] gap-[8px]">
                        <div className="bg-[#1A1A19] border-2 border-[#272625] rounded-[8px] px-1.5 py-1">
                          <span className="text-[#7F7F7F]">Bet: </span>
                          <span className="text-[#DB1A28]">${player.bet}</span>
                        </div>
                        <div className="bg-[#1A1A19] border-2 border-[#272625] rounded-[8px] px-1.5 py-1">
                          <span className="text-[#7F7F7F]">Win: </span>
                          <span className="text-[#00FF19]">14.55%</span>
                        </div>
                      </div>
            ...
            <div className="flex gap-[12px]">
              <Dialog>
                <DialogTrigger asChild>
                  <Button variant={"secondary"} className="w-[210px]">
                    JOIN JACKPOT
                  </Button>
                </DialogTrigger>
                <InventoryDialog />
                    ...
                    <div key={index} className="flex items-center gap-[13px]">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <div className="border-2 text-[12px] px-2 py-1 leading-[14.4px] border-[#272625] bg-[#1A1A19] rounded-[6px]">
                          <span className="text-[#7F7F7F]">Payout: </span>
                          <span className="text-[#00FF19]">+{hist.payout}</span>
                        </div>
                      </div>
                    </div>
                  ))}
